            	...
            	success:function(data){
                    ...
                    if(that.admin == true){
                    	    utils.setupNativeMenu(menujson,function(data){
                    	    	var url = utils.getAbsoluteUrl("./compare_progress.html");
          ...
          centralize_a:function(){
	        ...
	        centralize: function () {
	            ...
	            $(".conList").on("click",function () {
	            	...
	            	var url = utils.getAbsoluteUrl("compare_detail_user.html");
                    utils.openNewWindow(url, para);
